 ...
 */
public abstract class BaseRequest extends BaseNetworkTask implements Runnable {
    public BaseRequest(BaseNetworkTask task) {
        super(task);
    }

    public BaseRequest(String url, Map<String, String> params, byte[] data, NetworkManager.ResultCallback callback) {
